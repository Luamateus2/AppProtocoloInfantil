...
type RouteProps =
  RouteProp<RootStackParamList, 'EditarIntraOperatorio'>;
...
export default function EditarIntraOperatorio() {
  ...
  const [dataRegistro, setDataRegistro] =
    useState('12/03/2026');
  ...
  async function carregarDados() {
    try {
      ...
      if (snap.exists()) {
        ...
        setDataRegistro(data.data || '12/03/2026');
        setHorarioInicio(data.horarioInicio || '09:15');
      ...
      Alert.alert(
        'Erro',
        'Não foi possível carregar o intra-operatório.'
      );
    } finally {
      setLoading(false);
    }
  ...
  function continuar() {
    navigation.navigate('EditarPosOperatorio', {
      pacienteId,
      pacienteEditado,
      preOperatorioEditado,
